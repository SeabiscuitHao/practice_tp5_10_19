<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"F:\www\Tp_try\think\public/../application/index\view\index\index.html";i:1508410089;s:69:"F:\www\Tp_try\think\public/../application/index\view\common\head.html";i:1508326876;s:70:"F:\www\Tp_try\think\public/../application/index\view\common\right.html";i:1508406184;s:71:"F:\www\Tp_try\think\public/../application/index\view\common\footer.html";i:1507639668;}*/ ?>
...
<div class="overall">
	...
	<div class="left">
		<?php if(is_array($articleres) || $articleres instanceof \think\Collection || $articleres instanceof \think\Paginator): $i = 0; $__LIST__ = $articleres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<div class="xnews2">
				<div class="pic"><a target="_blank" href="20160920156279.html"><img src="
					<?php if($vo['pic'] == ''): ?>
				...
				<div class="time"><a href='z97712.html'><?php echo $vo['keywords']; ?></a>  </div>
				<div class="time"> </div>
				</div>
				</div>
		<?php endforeach; endif; else: echo "" ;endif; ?>
